...
<template>
	<div class="flex-1 bg-slate-900 flex-row justify-center items-start pt-10">
		<form class="bg-slate-50 p-4 br-3 flex-col gap-2" @submit.prevent="register">
			<h2>Complete Registration</h2>
			<div class="bg-red-100 p-2 br-3 text-xs flex-col ga-p2" v-if="errorMsg">
				<p>{{ errorMsg }}</p>
			...
			<button class="btn btn__primary py-05 px1 items-self-end">Continue<IconsChevronRight /></button>
		</form>
	</div>
</template>
