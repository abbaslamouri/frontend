    ...
    subMenu: [
      {
        ...
        link: { title: 'Shop Original Coffee', page: 'ecommerce-coffee' },
      },
      {
  ...
  <div class="main-nav">
    <ul class="items">
      <li
        ...
        :key="item.title"
        @mouseenter="navLinkItems[index].show = true"
        @mouseleave="navLinkItems[index].show = false"
      >
        <div class="menu-item">
        ...
        <transition name="dropdown">
          <ul class="submenu shadow-md" v-show="item.show">
