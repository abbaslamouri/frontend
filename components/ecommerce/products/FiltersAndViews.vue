...
<template>
  <section class="flex-row items-center justify-between w-996p p-2">
    <button class="bg-white border border-slate-300 br-3 flex-row items-center gap-3 px-3 py-1 border">
      <span>Filter</span>
      <IconsFilter />
    </button>
